        ...
        <div id="wrapper">
          ...
          <section id="contentstart">
            ...
            <article className="col-3 brown">
              <h2>Airport</h2>
              <p>
                One of the most beautiful airports on the entire west coast, the Gold Beach Airport is located just
                south of the mouth of the Rogue River. Airport Code: 4S1
              </p>
              <p>
                <Link to="/Airport">
                  <button>Details</button>
